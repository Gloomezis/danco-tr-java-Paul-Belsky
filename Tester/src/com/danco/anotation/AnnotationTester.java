...
import com.danco.gloomezis.dependencyInjection.DependencyInjectionPropertyManager;
...
public class AnnotationTester {
	...
	*/
	    ...
	    printableAnalizer.printDetaildeView(hotelRoom);
	    printableAnalizer.printDetaildeView(service);
	    
	    System.out.println( implClassName = DependencyInjectionPropertyManager.getInstance().getImplClassName("com.danco.servise.api.IGuestService"));

	    
	    
	    MainStorage.setInstance(((ISerializeController)DependencyInjectionManager.getClassInstance(ISerializeController.class)).serialFromFile());  
