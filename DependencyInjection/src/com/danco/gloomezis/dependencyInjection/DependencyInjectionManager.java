...
public class DependencyInjectionManager {
	...
	/** The Constant LOG1. */
	private final static Logger LOG1 = Logger.getLogger(DependencyInjectionManager.class.getName());
	...
	public static Object getClassInstance(Class<?> clazz){
		...
		if (objects.containsKey(clazz.getName())){
			...
			String implClassName = DependencyInjectionPropertyManager.getInstance().getImplClassName(clazz.getName());
			try {
