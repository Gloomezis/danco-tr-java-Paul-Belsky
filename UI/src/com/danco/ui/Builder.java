...
public class Builder {
	...
	public Menu buildMenu() {
		...
		firstMenu.getMenuItems().add(new MenuItems(READ_GUEST_FROM_FILE, new ReadGuestFromFile()));
		firstMenu.getMenuItems().add(new MenuItems(WRITE_GUEST_TO_FILE, new WriteGuestToFile()));
		...
		rootMenu.getMenuItems().add(new MenuItems(EXIT, null));
