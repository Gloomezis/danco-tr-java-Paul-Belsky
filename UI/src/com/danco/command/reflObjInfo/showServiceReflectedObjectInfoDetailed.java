...
/**
 * The Class showServiceReflectedObjectInfoDetailed.
 */
public class showServiceReflectedObjectInfoDetailed implements Command {
	
	/** The LO g1. */
	private final Logger LOG1 = Logger.getLogger(showServiceReflectedObjectInfoDetailed.class.getName());
	...
	private static final String PROTOCOL = "1" + ";"
			+ "showServiceReflectedObjectInfoDetailed" + ";";
